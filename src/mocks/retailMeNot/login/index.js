...
const RetailMeNotLogin = () => (
    <div>
        ...
        <Grid container spacing={0} style={{ paddingTop: '3%', paddingLeft: '10%', paddingRight: '10%', }} alignContent="center" alignItems="center" justify="center">
            <Grid item lg={4}>
            </Grid>
            <Grid item lg={4} style={{ maxWidth: 320}}>
